...
From mbedtls 3.6.5 to /opt/cross-mint/m68k-atari-mint/lib/
...
- get [mbedtls-3.6.5.zip](https://ptonthat.fr/files/polarssl/mbedtls-3.6.5.zip), you'll need only to unpack  
...
- get [libmbedtls.a.r5.zip](https://ptonthat.fr/files/polarssl/sources/libmbedtls.a.r5.zip) and unpack the contents of /libmdbedtls.a/ to  
   ```./README.md```  
   ```./Makefile```  
...
- libmbedtls.xcodeproj is for Xcode 26.1, you may not need it if you use something else.
